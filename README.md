...
| [ironclaw](https://github.com/nearai/ironclaw)                                                                                | `ghcr.io/tolkonepiu/ironclaw-worker`                                                                                                                           | [All](https://github.com/tolkonepiu/claw-images/pkgs/container/ironclaw-worker) |
...
| [`openclaw-full`](https://github.com/tolkonepiu/claw-images/blob/main/overlay-files/openclaw-full/Dockerfile)                 | OpenClaw image with extended CLI tooling                                                                                                                       | [OpenClaw](https://github.com/openclaw/openclaw)                                | `ghcr.io/tolkonepiu/openclaw-full`                 | [All](https://github.com/tolkonepiu/claw-images/pkgs/container/openclaw-full)                 |
...
| [`openclaw-sandbox-full`](https://github.com/tolkonepiu/claw-images/blob/main/overlay-files/openclaw-full/Dockerfile)         | OpenClaw sandbox image [with extended CLI tooling](https://github.com/tolkonepiu/claw-images/blob/main/overlays/openclaw-sandbox-full.json#L9)                 | [OpenClaw](https://github.com/openclaw/openclaw)                                | `ghcr.io/tolkonepiu/openclaw-sandbox-full`         | [All](https://github.com/tolkonepiu/claw-images/pkgs/container/openclaw-sandbox-full)         |
...
| [`openclaw-sandbox-browser-full`](https://github.com/tolkonepiu/claw-images/blob/main/overlay-files/openclaw-full/Dockerfile) | OpenClaw sandbox browser image [with extended CLI tooling](https://github.com/tolkonepiu/claw-images/blob/main/overlays/openclaw-sandbox-browser-full.json#L9) | [OpenClaw](https://github.com/openclaw/openclaw)                                | `ghcr.io/tolkonepiu/openclaw-sandbox-browser-full` | [All](https://github.com/tolkonepiu/claw-images/pkgs/container/openclaw-sandbox-browser-full) |
| [`qwenpaw`](https://github.com/agentscope-ai/QwenPaw/blob/main/deploy/Dockerfile)                                             | Personal AI assistant, easy to deploy                                                                                                                          | [QwenPaw](https://github.com/agentscope-ai/QwenPaw)                             | `ghcr.io/tolkonepiu/qwenpaw`                       | [All](https://github.com/tolkonepiu/claw-images/pkgs/container/qwenpaw)                       |
...
4. If the overlay Dockerfile expects additional build arguments, add an optional
   `overlay.args` object. Each key/value pair is passed through as a Docker
   build argument after `BASE_IMAGE`, which is always provided automatically.
   Keys and values must be single-line strings.
5. Open a pull request to validate the build.
